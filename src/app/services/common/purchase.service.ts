...
export class PurchaseService {
  ...
  getAllPurchase(filterData: FilterData, searchQuery?: string) {
    ...
    return this.httpClient.post<{ data: ProductPurchase[], count: number, success: boolean, calculation: any }>(API_NEW_PURCHASE + 'get-all-by-shop/', filterData, {params});
  }
  ...
  getSimilarProducts(productId: string,dateString:any): Observable<any> {
    ...
    return this.httpClient.get<any>(API_NEW_PURCHASE + 'similar/' + productId, { params });
  }
