...
export class ReloadService {
  ...
  private refreshColor = new Subject<void>();
  private refreshSize = new Subject<void>();
  ...
  private refreshSideNav = new Subject<void>();
  /**
   * REFRESH GLOBAL
   */
  get refreshBrand$() {
