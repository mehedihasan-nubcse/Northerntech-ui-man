...
import { PresaleProduct, PresaleProductCalculation } from 'src/app/interfaces/common/presale-product.interface';
import { ShopInformation } from 'src/app/interfaces/common/shop-information.interface';
import { Vendor } from 'src/app/interfaces/common/vendor.interface';
...
import { PresaleProductService } from 'src/app/services/common/presale-product.service';
import { ProductDamageService } from 'src/app/services/common/product-damage.service';
import { ShopInformationService } from 'src/app/services/common/shop-information.service';
import { VendorService } from 'src/app/services/common/vendor.service';
...
@Component({
  ...
  styleUrls: ['./custom-table-list.component.scss']
})
export class CustomTableListComponent implements OnInit {
  ...
  holdPrevData: PresaleProduct[] = [];
  categories: Category[] = [];
  vendors: Vendor[] = [];
  productCalculation: PresaleProductCalculation;
