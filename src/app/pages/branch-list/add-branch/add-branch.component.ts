...
export class AddBranchComponent implements OnInit {
  ...
  private addShop() {
    ...
    this.subDataOne = this.shopService.addShop(this.dataForm.value)
      .subscribe({
        next: (res => {
  ...
  private getShopById() {
    this.spinnerService.show();
    this.subDataTwo = this.shopService.getShopById(this.id)
      .subscribe({
        next: (res => {
          this.spinnerService.hide();
          if (res.data) {
  ...
  private updateShopById() {
    this.spinnerService.show();
    this.subDataThree = this.shopService.updateShopById(this.shop._id, this.dataForm.value)
      .subscribe({
        next: (res => {
          this.spinnerService.hide();
          if (res.success) {
