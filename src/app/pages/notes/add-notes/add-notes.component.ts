...
export class AddNotesComponent implements OnInit {
  ...
  private setFormValue() {
    this.dataForm.patchValue(this.notes);

    // Set Image
    if (this.notes.images && this.notes.images.length) {
      this.chooseImage = this.notes.images;
    }
  }
  ...
  private addNotes() {
    ...
    this.subDataOne = this.notesService.addNotes(this.dataForm.value)
      .subscribe({
        next: (res => {
  ...
  private getNotesById() {
    this.spinnerService.show();
    this.subDataTwo = this.notesService.getNotesById(this.id)
      .subscribe({
        next: (res => {
          this.spinnerService.hide();
          if (res.data) {
  ...
  private updateNotesById() {
    this.spinnerService.show();
    this.subDataThree = this.notesService.updateNotesById(this.notes._id, this.dataForm.value)
      .subscribe({
        next: (res => {
          this.spinnerService.hide();
          if (res.success) {
