...
import {ProductLogService} from "../../../services/common/product-log.service";
...
export class ProductTrashComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private productService: ProductLogService,
    // private p: ProductLogService,
    ...
    this.subForm = formValue
      .pipe(
        ...
        switchMap((data) => {
          ...
          return this.productService.getAllProductLogs(
            filterData,
            this.searchQuery
          );
        })
  ...
  private getAllProducts() {
    ...
    this.subDataOne = this.productService
      .getAllProductLogs(filter, this.searchQuery)
      .subscribe({
        next: (res) => {
  ...
  private getAllProducts2() {
    ...
    this.subDataOne = this.productService
      .getAllProductLogs(filterData, null)
      .subscribe({
        next: (res) => {
          if (res.success) {
  ...
  private deleteMultipleProductById() {
    ...
    this.subDataTwo = this.productService
      .deleteMultipleProductLogById(this.selectedIds)
      .subscribe({
        next: (res) => {
          this.spinner.hide();
          if (res.success) {
  ...
  exportToAllExcel() {
    ...
    this.subDataOne = this.productService.getAllProductLogs(filterData, this.searchQuery)
      .subscribe({
        next: (res => {
