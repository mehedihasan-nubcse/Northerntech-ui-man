...
import {PresaleProduct, PresaleProductCalculation} from '../../../../interfaces/common/presale-product.interface';
...
@Component({
  ...
  templateUrl: './presale-product-list.component.html',
  styleUrls: ['./presale-product-list.component.scss'],
})
export class PresaleProductListComponent implements OnInit, AfterViewInit, OnDestroy {
