...
@Component({
  selector: 'app-in-stock-history',
  templateUrl: './in-stock-history.component.html',
  styleUrls: ['./in-stock-history.component.scss'],
  providers:[DatePipe]
})
export class InStockHistoryComponent implements OnInit, OnDestroy {
  // Admin Base Data
  adminId: string;
  role: string;
  ...
  exportToAllExcel() {
    ...
    if (this.selectedIds.length) {
      ...
      XLSX.writeFile(wb, `Purchase_${date}.xlsx`);
